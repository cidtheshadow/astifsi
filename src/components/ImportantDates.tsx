      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          ...
          <div className="bg-white p-3.5 rounded-xl border border-stone-200 shadow-2xs flex items-center gap-3 shrink-0">
            ...
            <span className="text-xs font-bold text-[#002e1f]">Abstract Submission Closes: October 4, 2026</span>
          </div>
        </div>
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <span className="text-2xl font-black text-[#002e1f] font-display-hero">
                    0{idx + 1}
                  </span>
                  ...
                  {item.isUrgent ? (
                    ...
                    <span className="text-[10px] uppercase font-bold tracking-wider px-2.5 py-0.5 rounded-full bg-stone-100 text-stone-600 border border-stone-200">
                      Milestone
                    </span>
                  )}
                </div>
                ...
                {/* Date Display */}
                <div className="mb-3">
                  <span className="inline-block px-3 py-1 rounded-full bg-[#D1FAE5] text-[#002e1f] text-xs font-bold font-heading">
                    {item.date}
                  </span>
                </div>

                <h3 className="text-base font-bold text-[#002e1f] mb-2 font-heading">
                  {item.title}
                </h3>
              ...
              {item.isUrgent ? (
                <div className="pt-3 border-t border-amber-200">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg text-xs font-bold bg-[#002e1f] text-white hover:bg-[#0E5A40] transition-colors uppercase tracking-wider shadow-xs"
                  >
                ...
                <div className="pt-3 border-t border-stone-100 flex items-center gap-1.5 text-xs text-stone-500 font-medium">
